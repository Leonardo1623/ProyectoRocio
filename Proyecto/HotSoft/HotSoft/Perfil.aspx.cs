...
namespace HotSoft
{
    public partial class Perfil : System.Web.UI.Page
    {
        ...
        protected void btnGuardarAptitud_Click(object sender, EventArgs e)
        {
            ...
            {
                string tumadre = CheckBox34.Text;
            }
        ...
        protected void btnGuardarCurso_Click(object sender, EventArgs e)
        {
            ...
            if (ChkSharp.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "C#", "CERTIFICACIONES");
            if (ChkHtml.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "HTML", "CERTIFICACIONES");
            if (ChkEnsamblador.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Ensamblador", "CERTIFICACIONES");
            if (ChkNesc.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "NesC", "CERTIFICACIONES");
            if (ChkC.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "C", "CERTIFICACIONES");
            if (ChkPython.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Python", "CERTIFICACIONES");

            if (ChkRuby.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Ruby", "CERTIFICACIONES");
            if (ChkCss.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "CSS", "CERTIFICACIONES");
            if (ChkFortran.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Fortran", "CERTIFICACIONES");
            if (ChkProlog.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Prolog", "CERTIFICACIONES");
            if (ChkMasmas.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "C++", "CERTIFICACIONES");
            if (ChkPascal.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Pascal", "CERTIFICACIONES");

            if (ChkVisual.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Visual Studio", "CERTIFICACIONES");
            if (ChkJava.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Java", "CERTIFICACIONES");
            if (ChkUml.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "UML", "CERTIFICACIONES");
            if (ChPhp.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "PHP", "CERTIFICACIONES");
            if (ChkCobol.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "Cobol", "CERTIFICACIONES");
            if (ChkJavascrip.Checked == true)
                Cursos.CertiCursoApti(ID_CURRICULUM, "JavaScript", "CERTIFICACIONES");
        }
    }
}